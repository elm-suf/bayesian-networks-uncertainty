...
public class CSVFormat implements Serializable {
	 ...
	 */
	public synchronized double parse(final String str) throws Exception {
		try {
			if( str.equals("?")) { 
				return Double.NaN;
			} if( str.equalsIgnoreCase("NaN") ) {
			...
			throw new Exception("Error:" + e.getMessage() + " on [" + str + "], decimal:" + this.decimal + ",sep: " + this.separator);
		}
	}
}
